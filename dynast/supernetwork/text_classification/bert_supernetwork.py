...
from ..machine_translation.modules_supernetwork import EmbeddingSuper, LinearSuper
...
class BertSupernetEncoder(BertEncoder):
    ...
    def set_sample_config(self, subnetwork_config):
        ...
        for layer_idx in range(self.subnet_num_layers):
            sub_layer_config = {'intermediate_size':subnetwork_config['intermediate_size'][layer_idx],
