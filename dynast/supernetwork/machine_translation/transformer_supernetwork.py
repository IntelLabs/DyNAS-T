...
from fairseq.models import BaseFairseqModel, FairseqEncoder, FairseqIncrementalDecoder
from fairseq.modules import PositionalEmbedding, SinusoidalPositionalEmbedding
from torch import nn

from .modules_supernetwork import EmbeddingSuper, LayerNormSuper, LinearSuper, MultiheadAttentionSuper
...
class TransformerEncoder(FairseqEncoder):
    ...
    def __init__(self, encoder_config, dictionary, embed_tokens):
        ...
        self.layers.extend([TransformerEncoderLayer(encoder_config, layer_idx=i) for i in range(self.super_layer_num)])
    ...
    def set_sample_config(self, config: dict):
        ...
        self.sample_embed_scale = (
            math.sqrt(self.sample_embed_dim) if not self.vocab_original_scaling else self.super_embed_scale
        )
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, decoder_config, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.super_self_attention_heads = (
            8 * [decoder_config['decoder_attention_heads']] * decoder_config['decoder_layers']
        )
        ...
        self.project_out_dim = (
            Linear(self.super_embed_dim, self.output_embed_dim, bias=False)
    ...
    *args.encoder_normalize_before* to ``True``.
    ...
    def set_sample_config(
        ...
        self.self_attn.set_sample_config(
            sample_q_embed_dim=self.sample_embed_dim, sample_attention_heads=self.sample_self_attention_heads_this_layer
        )
